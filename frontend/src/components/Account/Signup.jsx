...
export const Signup = () => {
  ...
  return (
    <div className="flex-1 flex px-8 md:p-0 items-center justify-center">
      <div className="-translate-y-6 h-fit shadow-2xl my-12 lg:w-[70%] rounded-lg min-h-[90%] flex">
        <div className="bg-signup bg-center rounded-l-lg hidden lg:inline flex-1">
          <div className="flex px-6 text-center flex-col justify-center items-center h-full gap-6">
            <div>
              <h1 className="text-white font-[700] text-4xl mb-3 font-Rubik">
                Hey There! 👋🏻
              </h1>
              <h1 className="text-white font-[700] text-4xl font-Rubik">
                Get Started with Task Pilot
              </h1>
            </div>
            <p className="text-white font-Poppins px-6 font-[600] text-center bottom-9">
              &quot;
        ...
        <div className="bg-white py-12 lg:w-[50%] min-h-full px-6 md:px-16 rounded-lg lg:rounded-none lg:rounded-r-lg flex justify-center flex-col">
          <div className="mb-8">
          ...
          >
            <input
              ...
              placeholder="Name"
              required
              className="p-2 rounded-md bg-gray-200 border-gray-300 font-Rubik border focus:outline-none"
            ...
            <div className="relative w-full">
              <input
                ...
                required
                className="p-2 rounded-md w-full bg-gray-200 border-gray-300 font-Rubik border focus:outline-none"
